...
`
  ...
  private async waitForUserConfirmation(): Promise<void> {
    ...
    return new Promise((resolve) => {
      console.log("\n" + "=".repeat(80))
      console.log("⚠️  WARNING: ABOUT TO PUSH TO PUBLIC REPOSITORY")
      console.log("=".repeat(80))

      console.log("\n🚨 IMPORTANT:")
      console.log("   • This will push ONLY quartz/ and api/ directories")
      console.log("   • ALL content, scripts, docs, and other files will be EXCLUDED")
      console.log("   • This is a SOURCE-ONLY repository")
      console.log("   • No personal content, drafts, or private files will be included")

      console.log("\n📁 What's being included:")
      console.log("   ✅ quartz/ (Quartz framework source code)")
      console.log("   ✅ api/ (API-related files)")
      console.log("   ✅ Essential config files (package.json, tsconfig.json, etc.)")
      ...
      rl.question(
        ...
        (answer) => {
          ...
          if (answer.toLowerCase() === "yes") {
            this.log("🚀 Proceeding with push to public repository...", "success")
            resolve()
          } else {
            this.log("❌ Push cancelled by user", "warning")
            process.exit(0)
          }
        },
      )
  ...
  private async waitForFastModeConfirmation(): Promise<void> {
    ...
    return new Promise((resolve) => {
      ...
      console.log("\n📋 What will be done:")
      console.log("   ✅ Include ONLY quartz/ and api/ directories")
      console.log("   ✅ Include essential configuration files")
      console.log("   ✅ Exclude ALL content, scripts, docs, and other files")
      ...
      console.log("   ✅ Configuration files (.gitignore, .prettierrc, etc.)")
      console.log("   ✅ Build files (Dockerfile)")
